  ...
  export default {
    ...
    data () {
      return {
        ...
        firstText: 'C понедельника по четверг действует акция: с 12:00-17:00 на кальяны скидка 30% (Serbetli, Afzal, Fusion, Adalya, Al Fakher, Fasil: 126грн). Дымный с нетерпением ждет Тебя в гости',
        secondText: 'Именинники в нашем баре не останутся без подарков Отмечайте свой день рождения у нас, и получайте кальян в подарок. Просим при себе иметь документ, подтверждающий дату рождения',
