  ...
  export default {
    ...
    head: {
      ...
      meta: [
        ...
        // { hid: 'keywords', name: 'keywords', content: 'Кальян-бар, Калян бар, кальян на кпи, ВДНХ, КПИ, КПІ ВДНГ, Киев, кальян-бар, кальян, DOIT, дуит, покурить кальян, кальянная, кальянный кейтеринг, аренда кальяна, кальян на выезд, первый кальян бар на ВДНХ' },
